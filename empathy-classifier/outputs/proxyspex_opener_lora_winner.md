...
Checkpoint: `/sci/labs/orzuk/shaulytolk/LLMES/empathy-classifier/src/../models/lora_winner_seed9.pt`

Config: {'model': 'lora_winner', 'k_per_cell': 10, 'n_opener_words': 10, 'n_masks': 256, 'k_order_max': 3, 'batch_size': 32, 'n_eval_proxy': 4096, 'out_tag': 'lora_winner'}
...
Interaction-order distribution (top-10 per example): {1: 11, 2: 62, 3: 127}
Top tokens: `that` (0.31), `really` (0.31), `I'm` (0.29), `I` (0.27), `sorry` (0.24), `this` (0.23), `your` (0.21), `and` (0.21), `feeling` (0.20), `you` (0.20), `you're` (0.17), `can` (0.16), `It's` (0.15), `to` (0.12), `hear` (0.11)
Top positions: pos7:57, pos9:57, pos5:56, pos1:53, pos6:53, pos0:52, pos2:51, pos8:46, pos4:46, pos3:45

### True = Affective  (20 examples)

Interaction-order distribution (top-10 per example): {1: 16, 2: 65, 3: 119}
Top tokens: `I` (0.34), `the` (0.29), `you` (0.28), `and` (0.22), `can` (0.21), `to` (0.21), `feel` (0.14), `must` (0.14), `your` (0.13), `of` (0.12), `truly` (0.11), `that` (0.10), `have` (0.09), `completely` (0.09), `What` (0.09)
Top positions: pos0:61, pos6:54, pos2:54, pos1:53, pos9:53, pos3:50, pos7:50, pos5:47, pos8:43, pos4:38

### True = Motivational  (20 examples)

Interaction-order distribution (top-10 per example): {1: 17, 2: 39, 3: 144}
Top tokens: `I'm` (0.30), `that` (0.29), `can` (0.25), `hear` (0.24), `you're` (0.22), `I` (0.22), `sorry` (0.20), `you` (0.20), `really` (0.19), `to` (0.18), `going` (0.17), `through` (0.15), `this` (0.14), `the` (0.13), `your` (0.13)
Top positions: pos1:62, pos9:60, pos0:59, pos5:58, pos7:50, pos8:50, pos2:50, pos4:48, pos3:48, pos6:42
...
opener: `It's evident that you initially experienced a sense of uneasiness`
  - F=+0.014  |T|=2  tokens=['evident', 'experienced']  (positions [1, 5])
  - F=-0.013  |T|=3  tokens=["It's", 'that', 'you']  (positions [0, 2, 3])
...
opener: `I can see how you might be feeling frustrated and`
  ...
  - F=+0.016  |T|=2  tokens=['frustrated', 'and']  (positions [8, 9])
  - F=+0.016  |T|=3  tokens=['I', 'feeling', 'frustrated']  (positions [0, 7, 8])
...
opener: `I completely understand why you'd feel angry and upset; being`
  ...
  - F=+0.012  |T|=3  tokens=['understand', "you'd", 'upset;']  (positions [2, 4, 8])
...
opener: `I can really identify with the stress and nervousness you`
  ...
  - F=+0.016  |T|=2  tokens=['really', 'identify']  (positions [2, 3])
...
opener: `It must be an emotional time for you, observing your`
  - F=+0.019  |T|=3  tokens=['time', 'for', 'observing']  (positions [5, 6, 8])
...
opener: `It's evident that you experienced a rollercoaster of emotions during`
  ...
  - F=-0.016  |T|=1  tokens=['rollercoaster']  (positions [6])
...
opener: `I'm really sorry that you're feeling this way, but I'm`
  ...
  - F=-0.015  |T|=2  tokens=['way,', "I'm"]  (positions [7, 9])

### idx=1163 [Cog/wrong] true=Cognitive
opener: `I'm really sorry to hear that you're feeling this way,`
  - F=+0.017  |T|=2  tokens=['sorry', 'that']  (positions [2, 5])
  - F=-0.016  |T|=3  tokens=['feeling', 'this', 'way,']  (positions [7, 8, 9])
...
opener: `I'm really sorry to hear what you're going through, and`
  ...
  - F=+0.013  |T|=3  tokens=['really', "you're", 'and']  (positions [1, 6, 9])

### idx=842 [Cog/wrong] true=Cognitive
opener: `I'm really sorry to hear that you've been feeling this`
  - F=-0.015  |T|=3  tokens=["I'm", 'sorry', 'this']  (positions [0, 2, 9])
  - F=+0.015  |T|=2  tokens=["you've", 'been']  (positions [6, 7])
  - F=+0.014  |T|=2  tokens=["I'm", 'this']  (positions [0, 9])

### idx=873 [Cog/wrong] true=Cognitive
opener: `I'm really sorry to hear that you're feeling underappreciated and`
  - F=-0.015  |T|=2  tokens=['feeling', 'and']  (positions [7, 9])
  - F=-0.014  |T|=3  tokens=["I'm", 'really', 'and']  (positions [0, 1, 9])
  - F=+0.013  |T|=3  tokens=["you're", 'feeling', 'and']  (positions [6, 7, 9])
...
opener: `I'm really sorry to hear about your granddad's passing. It's`
  ...
  - F=-0.012  |T|=2  tokens=['your', "It's"]  (positions [6, 9])
...
opener: `I'm so sorry for your loss, and I can really`
  - F=-0.017  |T|=3  tokens=['so', 'and', 'really']  (positions [1, 6, 9])
  - F=-0.016  |T|=2  tokens=['so', 'I']  (positions [1, 7])
  - F=-0.012  |T|=3  tokens=['for', 'I', 'can']  (positions [3, 7, 8])
...
opener: `I truly feel for you and your family during this`
  ...
  - F=+0.015  |T|=3  tokens=['I', 'you', 'your']  (positions [0, 4, 6])
...
opener: `I can almost feel the warmth and joy you experienced`
  ...
  - F=-0.014  |T|=3  tokens=['feel', 'warmth', 'you']  (positions [3, 5, 8])
  - F=+0.014  |T|=3  tokens=['can', 'warmth', 'joy']  (positions [1, 5, 7])
...
opener: `I can't begin to imagine the terror and desperation you`
  - F=+0.016  |T|=3  tokens=["can't", 'begin', 'you']  (positions [1, 2, 9])
  - F=-0.014  |T|=3  tokens=['to', 'and', 'desperation']  (positions [3, 7, 8])
  - F=-0.013  |T|=3  tokens=['begin', 'desperation', 'you']  (positions [2, 8, 9])

### idx=869 [Aff/corre] true=Affective
opener: `Seeing your son making his sister laugh must really touch`
  - F=-0.018  |T|=3  tokens=['son', 'laugh', 'touch']  (positions [2, 6, 9])
  - F=-0.015  |T|=1  tokens=['son']  (positions [2])
  - F=+0.014  |T|=2  tokens=['Seeing', 'son']  (positions [0, 2])
...
opener: `Wow, it's truly heartwarming to hear about your daughter's progress.`
  ...
  - F=-0.012  |T|=3  tokens=['Wow,', 'about', 'progress.']  (positions [0, 6, 9])
